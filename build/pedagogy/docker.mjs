// docker pedagogy — the authored layer of The Container Shipyard.
// Recovered from data/docker.js + docker.html so the flagship ship is built by
// the same pipeline as every other one instead of being hand-maintained.
export default {
  ...
  legacyStorageKeys: ['shipyard-v1'],
  accent: "#ffb000",
  stackLabel: 'THE STACK — your container',
  ranks: ['SWABBIE', 'DECKHAND', 'BOATSWAIN', 'FIRST MATE', 'DOCKER CAPTAIN', 'HARBOR MASTER'],

  boot: [
      "<div class=\"bl\">$ shipyard boot --curriculum docker-first-principles</div>",
      ...
      "<div class=\"bl\"><span class=\"warn\">WARNING: the exercises ARE the curriculum. Skipping them is not allowed.</span></div>",
      "<div class=\"bl\">AWAITING CREW — 14 waypoints ahead. <span class=\"cursor\" style=\"color:var(--accent)\">▮</span></div>"
  ],
  h1: "DOCKER, UNDERSTOOD.<br><span class=\"wh\">NOT JUST OPERATED.</span>",
  sub: "This is a first-principles curriculum rebuilt as a mission. Learn the core mental model <b>deeply</b>, reference the rest, and physically <b>build your own container</b> in the sidebar as you complete parts. Quizzes earn XP. Ranks go from <b>Swabbie</b> to <b>Harbor Master</b>. Finish all 14 parts and the shipyard ships your container.",
  foot: {
    about: "The Container Shipyard is a faithful interactive conversion of the first-principles Docker curriculum — every concept, table, code block, exercise and interview question preserved. Progress lives in your browser (localStorage). Built as a single file — copy it anywhere, it runs offline.",
    rule: "a container is just a process. Remember that and you'll never drown.",
  },
  grad: {
  ...
  simPrompt: '# docker run -d -p 8080:80 --name web nginx',
  egg: {
  ...
  chips: {
      "p1": [
          "<span class=\"m\">MODE <b>READ</b></span>"
      ],
      "p2": [
          "<span class=\"m\">MODE <b>READ</b></span>",
          "<span class=\"m\">★ <b>MOST IMPORTANT PART</b></span>"
      ],
      "p3": [
          "<span class=\"m\">MODE <b>HANDS-ON</b></span>",
          "<span class=\"m\">REQUIRES <b>DOCKER INSTALLED</b></span>"
      ],
      "p4": [
          "<span class=\"m\">MODE <b>HANDS-ON</b></span>"
      ],
      ...
      "p8": [
          "<span class=\"m\">MODE <b>HANDS-ON</b></span>",
          "<span class=\"m\">★ <b>THE PAYOFF</b></span>"
      ],
      "p9": [
          "<span class=\"m\">MODE <b>REFERENCE</b></span>"
      ],
      "p10": [
          "<span class=\"m\">★ <b>INTERVIEW GOLD</b></span>"
      ],
      "p13": [
          "<span class=\"m\">MODE <b>FLIP-CARDS</b></span>",
          "<span class=\"m\">★ <b>ANSWER ALOUD</b></span>"
      ],
      "p14": [
          "<span class=\"m\">MODE <b>CHECKLIST</b></span>",
          "<span class=\"m\">★ <b>GRADUATION</b></span>"
      ]
  },
  simIn: "p3",
  deckIn: "p13",
  milesIn: "p14",
  deckNote: 'You&#39;ve already built the answers; this consolidates them. <b>Answer each question aloud before flipping the card.</b> Nail a card and it dims. Every card maps to the section where you built the answer.',
  milesNote: "Six milestones = six layers of proof. Check each off honestly — when all six drop, <b>the shipyard ships your container</b>.",
